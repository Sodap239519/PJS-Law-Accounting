                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="excerpt_th" name="excerpt_th" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-pjs-blue-500 dark:focus:border-pjs-blue-600 focus:ring-pjs-blue-500 dark:focus:ring-pjs-blue-600 rounded-md shadow-sm">{{ old('excerpt_th') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="excerpt_en" name="excerpt_en" rows="2" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-pjs-blue-500 dark:focus:border-pjs-blue-600 focus:ring-pjs-blue-500 dark:focus:ring-pjs-blue-600 rounded-md shadow-sm">{{ old('excerpt_en') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content_th" name="content_th" rows="10" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-pjs-blue-500 dark:focus:border-pjs-blue-600 focus:ring-pjs-blue-500 dark:focus:ring-pjs-blue-600 rounded-md shadow-sm" required>{{ old('content_th') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content_en" name="content_en" rows="10" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-pjs-blue-500 dark:focus:border-pjs-blue-600 focus:ring-pjs-blue-500 dark:focus:ring-pjs-blue-600 rounded-md shadow-sm" required>{{ old('content_en') }}</textarea>
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} class="rounded border-gray-300 dark:border-gray-700 text-pjs-blue-600 shadow-sm focus:ring-pjs-blue-500 dark:focus:ring-pjs-blue-600 dark:focus:ring-offset-gray-800">

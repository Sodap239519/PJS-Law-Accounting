...
<template>
    ...
    <AdminLayout>
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <DraftManager :form="form" :fields="['title', 'content', 'client_name', 'translations']" :storage-key="'case-' + (caseStudy?.id || 'new')" :enabled="!isEdit" />
        ...
        <FloatingSaveBar :processing="form.processing" :save-label="isEdit ? 'บันทึก' : 'สร้าง'" @save="submit" @cancel="router.visit(route('admin.case-studies.index'))" />
    </AdminLayout>
</template>

...
<template>
    ...
    <AdminLayout>
        ...
        <div class="space-y-2 sm:hidden">
            <div v-for="item in cases.data" :key="item.id" class="flex gap-3 rounded-xl border border-slate-100 bg-white p-3 shadow-sm">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div class="mt-2 flex gap-4 text-sm">
                        <Link :href="route('admin.case-studies.edit', item.id)" class="text-pjs-blue">แก้ไข</Link>

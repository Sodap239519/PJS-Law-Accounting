...
<template>
    ...
    <AdminLayout>
        <form class="space-y-6" @submit.prevent="submit">
            ...
            <DraftManager :form="form" :fields="['title', 'content', 'excerpt', 'translations']" :storage-key="'announcement-' + (announcement?.id || 'new')" />
        ...
        <FloatingSaveBar :processing="form.processing" :save-label="isEdit ? 'บันทึก' : 'สร้าง'" @save="submit" @cancel="router.visit(route('admin.announcements.index'))" />
    </AdminLayout>
</template>

...
gulp.task('scss', () => {
    return gulp
        .src('app/assets/scss/template.scss')
        .pipe(sass())
...
gulp.task('default', gulp.series( gulp.parallel('pug','scss','js-jquery','js-bootstrap','js-plugins','js-core','css','images','fonts','video','php', serve, 'watch')));
